...
var getQSAnim = function getQSAnim(items, left, right) {
  var animations = [];
  animations.push([0, 0, false]);
  var animat = quickSortHelper(items, left, right, animations);
  return animat;
};

exports.getQSAnim = getQSAnim;